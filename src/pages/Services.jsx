...
const Services = () => {
  return (
    <div className="services-page">
      <div className="page-header" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1200&q=80')" }}>
            ...
            {servicesList.map((svc, idx) => (
              <div className={`service-row ${idx % 2 !== 0 ? 'reverse' : ''}`} key={idx}>
                <div className="service-image">
                  <img 
                    src={svc.img} 
                    alt={`Techbrain Networks ${svc.title} team representation`} 
                    loading="lazy" 
                    decoding="async" 
                    width="600" 
                    height="400" 
